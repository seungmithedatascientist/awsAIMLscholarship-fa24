...
def adjust_results4_isadog(results_dic, dogfile):
    ...
    for filename, attributes in results_dic.items():
      is_pet_dog = 1 if attributes[0] in dognames_dic else 0
      classifier_labels = attributes[1].split(",")
      is_classifier_dog = 1 if any(label in dognames_dic for label in classifier_labels) else 0
